...
**2️⃣. Expressing “I like…”**  
Мне нравится чай с водой. | I like tea with water.

**3️⃣. Identifying objects (“This is…”)**  
Это дерево. | This is a tree.

**4️⃣. Asking “Where is…?”**  
Где компьютер? | Where is the computer?

**5️⃣. Saying possession (“I have…”)**  
У меня есть интернет и компьютер. | I have the internet and the computer.

**6️⃣. Using prepositions (“in/with”)**  
Я в комнате с принтером. | I am in the room with the printer.
...
**2️⃣2️⃣. Expressing "something works and someone sees"**   
Шлюз работает, и пользователь видит обновление. | The gat
eway works, and the user sees the update.

**2️⃣3️⃣. Expressing "I see multiple things"**   
Я вижу озеро и поляну. | I see the lake and the meadow.

**2️⃣4️⃣. Expressing "someone sees something"**   
Пользователь видит устройство и обновление. | The user sees the device and the update.
...
**1️⃣0️⃣3️⃣. Пропускная способность зависит от соединения.** | Bandwidth depends on the connection.

**1️⃣0️⃣4️⃣. Даже если система работает, неисправность есть.** | Even if the system works, there is a malfunction.
